...
def CfInt(spar, B_field, sx, L,sh = 0,kappa1=2500):
    # spar: 1D array of parallel distance
    # B_field: 1D array of total B profile
    # sx: Parallel distance of X-point
    # L: Total parallel distance
    # sh: front position to solve for
    # kappa1: conductivity
